...
from .forms import CustomerForm, CustomUserCreationForm, UserForm
...
class FixedPopRequestMixin(PopRequestMixin):
    def save(self, commit=True):
        ...
        if (
            ...
            or self.request.POST.get("asyncUpdate") == "True"
        ):
...
def Pay(request, pk):
    ...
    myFormat = "%Y,%m,%d"
    myTime.strftime(myFormat)
    myTime2.strftime(myFormat)
